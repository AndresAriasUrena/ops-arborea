  ...
  { id: "checkin", role: "limpieza", label: "Check-in · Preparación", icon: "bed",
    ...
    sections: [
      ...
      { title: "Exteriores", items: [
        ...
        { id: "ext_fregadero", label: "Lavar con esponja el fregadero externo", type: "check" },
        { id: "ext_madera", label: "Limpiar madera de los sillones externos", type: "check" },
        { id: "ext_ventanas", label: "Limpiar marcos de ventanas externas", type: "check" },
        { id: "ext_bbq", label: "Limpiar BBQ", type: "check" },
      ]},
      { title: "Control de calidad final", items: [
        ...
        { id: "qc_recorrido_final", label: "Recorrido final: una sola persona revisa toda la casa con el crew afuera", type: "check", required: true },
      ]},
    ],
  },
